...
└── src/
    ...
    │   ├── my-appointments.ejs
    │   └── profile.ejs            # Shared across all roles
    └── public/
...
Screenshots can be placed inside `docs/screenshots/`.
...
> **Note:** Place screenshots inside `docs/screenshots/` to make them visible here.
